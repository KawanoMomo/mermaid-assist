...
| [035](ECN-035_document-swap-state.md) | 文書を入れ替えても前の図の状態が残る欠陥 (A113〜A116) | 不具合修正 | (未リリース / PR #17) | 2026-08-22 |
| [036](ECN-036_telling-what-happened.md) | 黙って起きていたことを言うようにした (B29〜B35) | 改善 | (未リリース / PR #17) | 2026-08-22 |
| [037](ECN-037_checker-errors-outgrew-findings.md) | 検査の誤りが指摘を上回り、対策を作って撤去した (C63〜C91) | プロセス | (未リリース / PR #17) | 2026-08-22 |
